...
![](images/lab2/acoustic/bins.png){:height="400px" width="700px"}

This might be due to the fact that the real sampling frequency is lower than 8930Hz which means that the bins are narrower and the highest magnitude bin therefore occurs later. 
...
<iframe width="640" height="480" src="https://youtu.be/AESvnncbm_w" frameborder="0" allowfullscreen></iframe>
...
<iframe width="640" height="480" src="https://youtu.be/zLbhqgMi_pw" frameborder="0" allowfullscreen></iframe>
